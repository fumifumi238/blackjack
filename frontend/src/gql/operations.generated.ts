...
export type StartGameMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type StartGameMutation = { __typename?: 'Mutation', startGame?: { __typename?: 'Game', id?: string | null, status: string, playerScore?: number | null, dealerScore?: number | null, playerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }>, dealerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }> } | null };

export type HitMutationVariables = Types.Exact<{
  id: Types.Scalars['ID']['input'];
}>;


export type HitMutation = { __typename?: 'Mutation', hit?: { __typename?: 'Game', id?: string | null, status: string, playerScore?: number | null, dealerScore?: number | null, playerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }>, dealerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }> } | null };

export type StandMutationVariables = Types.Exact<{
  id: Types.Scalars['ID']['input'];
}>;


export type StandMutation = { __typename?: 'Mutation', stand?: { __typename?: 'Game', id?: string | null, status: string, playerScore?: number | null, dealerScore?: number | null, playerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }>, dealerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }> } | null };

export type FetchGameQueryVariables = Types.Exact<{
  id: Types.Scalars['ID']['input'];
}>;


export type FetchGameQuery = { __typename?: 'Query', gameState?: { __typename?: 'Game', id?: string | null, status: string, playerScore?: number | null, dealerScore?: number | null, playerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }>, dealerHand: Array<{ __typename?: 'Card', suit: string, rank: string, value: number }> } | null };
